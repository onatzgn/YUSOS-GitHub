...
const SOSScreen = ({ navigation }) => {
    ...
    const sendSOS = async () => {
        ...
        const username = userInfo.name; // Kullanıcının adını UserContext'ten alın
        const location = userInfo.medicalInfo ? userInfo.medicalInfo.address : 'Bilgi bulunamadı';
        const healthIssues = userInfo.medicalInfo ? userInfo.medicalInfo.healthIssues : 'Bilgi bulunamadı';
