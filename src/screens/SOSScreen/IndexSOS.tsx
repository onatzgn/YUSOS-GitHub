...
const SOSScreen = ({ navigation }) => {
    ...
    // Geçmiş yardım isteklerini yükleme
    useEffect(() => {
        // AsyncStorage'den geçmiş yardım isteklerini yükle
    ...
    const sendSOS = () => {
        ...
        // Yeni SOS çağrısını AsyncStorage veya başka bir yerde sakla
        // Örnek: AsyncStorage.setItem('helpRequests', JSON.stringify([...helpRequests, newRequest]));
